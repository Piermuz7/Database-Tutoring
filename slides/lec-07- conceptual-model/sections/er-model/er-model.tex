...
\begin{center}
    \begin{tikzpicture}[remember picture]
        ...
        % Draw shapes
        \node[rectangle] (studente) at (0, 0) {Studente};
        \node[rectangle] (professore) at (4, 0) {Professore};
        
        % Draw attribute line with black bullet for "matricola"
        \coordinate (matricolaStart) at ($(studente.west) + (-1.5, 0)$);
        \draw[decoration={markings,mark=at position 1 with {\draw[black, fill=black] circle [radius=2pt];}},postaction={decorate}] (studente.west) -- (matricolaStart);
        \node[left] at (matricolaStart) {matricola};
        
        % Draw attribute line with black bullet for "ID"
        \coordinate (idStart) at ($(professore.east) + (1.5, 0.4)$);
        \draw[decoration={markings,mark=at position 1 with {\draw[black, fill=black] circle [radius=2pt];}},postaction={decorate}] (professore.east) -- (idStart);
        \node[right] at (idStart) {ID};
        
        % Draw attribute line with white bullet for "orario"
        \coordinate (orarioStart) at ($(professore.east) + (1.5, -0.4)$);
        \draw[decoration={markings,mark=at position 1 with {\draw[white, fill=white] circle [radius=2pt];}},postaction={decorate}] (professore.east) -- (orarioStart);
        \draw[white, fill=white] (orarioStart) circle [radius=2pt];
        \draw (orarioStart) circle [radius=2pt];
        \node[right] at (orarioStart) {orario};
        
        % Draw vertical attribute line with white bullet for "nome" linked to "Studente"
        \coordinate (startNome) at ($(studente.south west) + (0.3,0)$);
        \coordinate (endNome) at ($(startNome) + (0,-1)$);
        \draw[decoration={markings,mark=at position 1 with {\draw[white, fill=white] circle [radius=2pt];}},postaction={decorate}] (startNome) -- (endNome);
        \draw[white, fill=white] (endNome) circle [radius=2pt];
        \draw (endNome) circle [radius=2pt];
        \node[below] at (endNome) {nome};

        % Draw vertical attribute line with white bullet for "cognome" linked to "Studente"
        \coordinate (startCognome) at ($(studente.south west) + (1.4,0)$);
        \coordinate (endCognome) at ($(startCognome) + (0,-1.5)$);
        \draw[decoration={markings,mark=at position 1 with {\draw[white, fill=white] circle [radius=2pt];}},postaction={decorate}] (startCognome) -- (endCognome);
        \draw[white, fill=white] (endCognome) circle [radius=2pt];
        \draw (endCognome) circle [radius=2pt];
        \node[below] at (endCognome) {cognome};

        % Draw vertical attribute line with white bullet for "dataNascita" linked to "Studente"
        \coordinate (startDataNascita) at ($(studente.south west) + (2.5,0)$);
        \coordinate (endDataNascita) at ($(startDataNascita) + (0,-2)$);
        \draw[decoration={markings,mark=at position 1 with {\draw[white, fill=white] circle [radius=2pt];}},postaction={decorate}] (startDataNascita) -- (endDataNascita);
        \draw[white, fill=white] (endDataNascita) circle [radius=2pt];
        \draw (endDataNascita) circle [radius=2pt];
        \node[below] at (endDataNascita) {dataNascita};

        % Draw vertical attribute line with white bullet for "nome" linked to "Professore"
        \coordinate (startNomeProf) at ($(professore.south west) + (0.3,0)$);
        \coordinate (endNomeProf) at ($(startNomeProf) + (0,-1)$);
        \draw[decoration={markings,mark=at position 1 with {\draw[white, fill=white] circle [radius=2pt];}},postaction={decorate}] (startNomeProf) -- (endNomeProf);
        \draw[white, fill=white] (endNomeProf) circle [radius=2pt];
        \draw (endNomeProf) circle [radius=2pt];
        \node[below] at (endNomeProf) {nome};

        % Draw vertical attribute line with white bullet for "cognome" linked to "Professore"
        \coordinate (startCognomeProf) at ($(professore.south west) + (1.4,0)$);
        \coordinate (endCognomeProf) at ($(startCognomeProf) + (0,-1.5)$);
        \draw[decoration={markings,mark=at position 1 with {\draw[white, fill=white] circle [radius=2pt];}},postaction={decorate}] (startCognomeProf) -- (endCognomeProf);
        \draw[white, fill=white] (endCognomeProf) circle [radius=2pt];
        \draw (endCognomeProf) circle [radius=2pt];
        \node[below] at (endCognomeProf) {cognome};

        % Draw vertical attribute line with white bullet for "dataNascita" linked to "Professore"
        \coordinate (startDataNascitaProf) at ($(professore.south west) + (2.5,0)$);
        \coordinate (endDataNascitaProf) at ($(startDataNascitaProf) + (0,-2)$);
        \draw[decoration={markings,mark=at position 1 with {\draw[white, fill=white] circle [radius=2pt];}},postaction={decorate}] (startDataNascitaProf) -- (endDataNascitaProf);
        \draw[white, fill=white] (endDataNascitaProf) circle [radius=2pt];
        \draw (endDataNascitaProf) circle [radius=2pt];
        \node[below] at (endDataNascitaProf) {dataNascita};
