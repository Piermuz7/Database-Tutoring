...
\setbeamertemplate{footline}{
    ...
    \hbox{%
        ...
        \begin{beamercolorbox}[wd=.333333\paperwidth,ht=2.25ex,dp=1ex,right]{date in head/foot}%
            \usebeamerfont{date in head/foot}17 aprile 2024\hspace*{5 em}
...
\section{Chi sono Piero e Piermichele?}
\input{sections/tutors.tex}
\section{Esame}
\input{sections/exam.tex}
\section{Lezioni}
\input{sections/lessons/lessons.tex}
