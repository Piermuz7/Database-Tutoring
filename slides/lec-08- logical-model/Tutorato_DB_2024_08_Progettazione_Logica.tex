...
\setbeamertemplate{footline}{
    ...
    \hbox{%
        ...
        \begin{beamercolorbox}[wd=.333333\paperwidth,ht=2.25ex,dp=1ex,right]{date in head/foot}%
            \usebeamerfont{date in head/foot}\insertshortdate\hspace*{5 em}
...
\input{sections/foundamentals-relational-model/foundamentals-relational-model.tex}
%
\section{La derivazione delle relazioni dal Modello E/R}
\input{sections/derivation-of-relationshiops-from-the-ER-model/derivation-of-relationshiops-from-the-ER-model.tex}
%
\section{Come tradurre un diagramma E/R in un Modello Logico di un Database}
\input{sections/design-logical-model-from-er-model/design-logical-model-from-er-model.tex}
%
\section{Conclusioni}
