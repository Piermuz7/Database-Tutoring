...
\input{sections/features-sql/sql-features.tex}
%
\section{Identificatori e tipi di dati}
\input{sections/identifier-datatypes/identifier-data-types.tex}
%
\section{Comandi per la Definizione di DB e Tabelle}
\input{sections/ddl/ddl.tex}
%
\section{Comandi per la Manipolazione dei Dati}
\input{sections/dml/dml.tex}
%
\section*{Clausole SQL}
\input{sections/sql-clauses/sql-clauses.tex}
%
\section{Comandi per il Controllo dei Dati}
\input{sections/dcl/dcl.tex}
%
\section{Comandi per il Controllo delle Transazioni}
\input{sections/tcl/tcl.tex}
\section{Conclusioni}
